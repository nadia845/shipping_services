        ...
        with ui.element("div").classes("flex flex-1 w-full"):
            ...
            with ui.element("div").classes(
                ...
                with ui.element("div").classes("w-full max-w-md"):
                    ...
                    # Header
                    with ui.row().classes(
                        "flex items-center justify-center sm:justify-start p-4 pb-6"
                    ):
                    ...
                    with ui.element("div").classes("space-y-4 px-4 py-3 w-full"):
                        ui.input(
                            ...
                            "w-full rounded-lg h-12 border border-[#cfd7e7] dark:border-[#2a3b5a] bg-[#f6f6f8] dark:bg-gray-800 focus:border-[#0A2463]"
                        )
                    ...
                    # Social Buttons
                    with ui.row().classes(
                        "grid grid-cols-1 sm:grid-cols-2 gap-4 px-4 py-3 w-full"
                    ):
                        ui.button(
                            "Sign in with Google", icon="fa-brands fa-google"
                        ).props("flat").classes(
                        ...
                        ui.button(
                            "Sign in with LinkedIn", icon="fa-brands fa-linkedin"
                        ).props("flat").classes(
                            "h-12 w-full justify-center gap-2 border border-[#cfd7e7] dark:border-[#2a3b5a] bg-[#f6f6f8] dark:bg-gray-800 text-[#0d121b] dark:text-white shadow-sm"
                        )
                    ...
                    ui.label(
                        ...
                        "text-xs text-[#4c669a] dark:text-gray-400 text-center px-4 pt-6 pb-2"
                    )
            ...
            with ui.element("div").classes(
                ...
                ui.element("div").classes("absolute inset-0 bg-cover bg-center").style(
                ...
                with ui.element("div").classes(
                    "relative z-10 max-w-lg p-12 text-white"
                ):
                    ui.label("Streamline Your Logistics with ShipSwift").classes(
